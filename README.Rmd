...
**Note**: The radius-edge ratio of a plolygon $\tau$ is given by $re = \frac{R}{l_{\text{min}}}$, where R is the circumradius and $l_{\text{min}}$ is the length of the shortest edge. The radius ratio $rr = \frac{r}{R}$, where $r$ is the inradius.
