...
#' Function to create the dual mesh polygons, suppied alongside the
#' \href{SPDE gitbook}{https://becarioprecario.bitbucket.io/spde-gitbook/}
#' @param mesh an \code{inla.mesh.2d()} object
#' @source zipfile linked here \url{https://www.r-inla.org/learnmore/books}
#' spde-book-files.zip/R/spde-book-functions.R
